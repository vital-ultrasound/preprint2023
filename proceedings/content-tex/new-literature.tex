...
Non-deep-learning techniques analyse cardiac cycles to analysis end-diastole and end-systolic left ventricular volumes with a mean correlation of 0.95 and absolute mean error of 9.5ml.
...
CAMUS and EchoNet-Dynamic 

\subsection{3D echochardiography}
\url{https://www.creatis.insa-lyon.fr/EvaluationPlatform/CETUS/about_database.html}
\url{https://www.creatis.insa-lyon.fr/EvaluationPlatform/CETUS/index.html}
