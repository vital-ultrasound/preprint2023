...
Despite the previous advances, the current practices of clinical ultrasound are user and patient dependant which can lead to uncertan diagnosis 
diagnostic. 
Particularly, the challenge of locating the right standard views from sonograpehrs of different experiences \cite{Feigenbaum1996}.
There are addiotional challenges in "low- and middle-income countries (LMICs)" where limited number of expert clinitians can perform such US imaging analysis and therfore accurate diagnosis.
...
On quasi real-time, non-real-time, analysis of echoardiography, Ghorbani et al. in 2020 reported the first deep learning model to predict age, sex, weight and height from echocardiogram images and make use of such models to understand how models predicts systematic phenotypes which are difficul for human interpreters \cite{Ghorbani-DigitalMedicineNature-JAN2020}.
...
In terms of real-time analysys of echocardigraphy, \cite{hanson2001} reviwed various applications of AI in the ICU where real-time analaysis of waveforms of electrocardiograms and electroencephalograms using neuoral network were used to idenfy cardiac ischemia and diagnosis myocardial ischemia. 
...
\cite{khamis2017} summaries various challenges related to performing echochardiography.
\begin{enumerate}
