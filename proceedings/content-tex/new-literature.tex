...
\textbf{Author(s), year} & \textbf{Datasets}                   & \textbf{Input \\ frames} & \textbf{Flops} & \textbf{Model;Params} & \textbf{Latency} & \textbf{Hyperparameters}      & \textbf{Code} \\
\cite{wu20222}           &  EchoDynamic (10Kc) \\ CAMUS (.5Kc) & 3                     & 56.359            & 74.798                    & 32 (ms/f)        & lr=10e-4;epochs=100;CR=5-fold & -             \\
