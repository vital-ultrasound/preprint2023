...
%Tetanus \% (with): 87.1\%.
See \appendixref{apd:datasets} for further details on the demographics of the dataset (distributions for sex, age, BMI, sepsis and dengue disease), including the complete dataset of the total of 87 patients.
