...
Supporting Real-time AI-empowered echocardiography for Intensive Care Units in low- and middle-income countries: A Machine Learning Case Study %Wed 31 Aug 06:18:13 BST 2022
}
...
\begin{abstract}
We present a machine learning case study on the current and future challenges for a real-time AI-empowered echocardiography system applied to ICU in LMICs.
Such case study includes reproducible heuristics from a video US dataset of 31 subjects in the ICU, data preparation, curation and labelling, model selection, validation and deployment.
...
%\item 
(a) Intra-view variability of echocardiograms (physiological variations of subjects and acquisition parameters) and inter-observer variability of expertise for sonographer and radiologist \citep{khamis2017, Feigenbaum1996, field2011},and 
...
% \item 
(b) Limited number of specialist clinicians to perform US imaging analysis and to provide accurate diagnosis, as well as equipment and hospitalisation requirements in low- and middle-income countries (LMICs) \citep{hao2021-wellcome, 2021-huyNhat-vanHao-in-FAIR-MICCAI}.
% \end{enumerate}
...
In spite of the success in applying AI and ML to support echocardiography, 
%and of many methods being available in the literature to solve the major technical challenges. 
there are still important challenges for these methods to be integrated as a system and translated to clinical practice:
...
\item inter-view similarity of echocardiograms (similar views of valve motion, wall motion, left ventricle, etc) when performing serial echoes and transducer position during acquisition \citep{zhang2018},
\item redundant information in the clinical echo system (icons, date, frame rate, etc) \citep{khamis2017} and variation of US images from different clinical US systems \citep{brindise2020unsupervised}, 
\item internal and external validation of AI-based models, data patient privacy to train commercial algorithms, and regulations of software as medical devices \citep{2022_Stewart_Emergency_Medicine_Australasia}, and 
...
Hence, this work presents a scoping review of (a) AI-empowered echocardiography for ICU in LMICs and (b) real-time AI-empowered echocardiography.
