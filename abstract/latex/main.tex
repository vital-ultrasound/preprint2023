...
\subsection{Datasets}
Echocardiography videos of 32 subjects in the ICU were considered for this which were collected by four clinicians of ? years of experience collected using clinical device GE Venue Go machine and GE convex probe C1-5-D.
The 32 subjects has the following characteristics:
Sex: \% (Male): 58.1\%;
