...
We present reproducible heuristics from a small video dataset of 31 subjects, data preparation, curation and labelling, code implementation of model selection, validation and deployment.
...
Also, \cite{2021-huyNhat-kerdegari-in-FAIR-MICCAI} presented a deep-learning lung US pathology classifier for ICU patient in LMIC, stating the challenges of data imbalance, integration of technology and IT infrastructure of the ICU in LMIC.
...
\subsection{Datasets}
Echocardiography videos of 31 subjects in the ICU were considered for this which were collected by four radiologists collected using clinical device GE Venue Go machine and GE convex probe C1-5-D.
