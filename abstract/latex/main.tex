...
Classifying echochardiograms has been sucessfully done in the previous years (\sectionref{subsec:nns_echochardiograms}), however real-time deployment suggest to require thinner networks.
